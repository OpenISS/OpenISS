...
t_iss_vfx_ops g_tVFXKinect1PCLOps;
...
void vfx_kinect1_pcl_DrawGLScene()
{
    short *depth = 0;
    char *rgb = 0;
    uint32_t ts;
    if (freenect_sync_get_depth((void**)&depth, &ts, 0, FREENECT_DEPTH_11BIT) < 0)
	vfx_kinect1_pcl_no_kinect_quit();
...
int vfx_kinect1_pcl_module_init()
{
    g_tVFXKinect1PCLOps.vfx_init = &vfx_kinect1_pcl_init;
    g_tVFXKinect1PCLOps.vfx_draw = &vfx_kinect1_pcl_draw;
    g_tVFXKinect1PCLOps.vfx_free = &vfx_kinect1_pcl_free;
    
    g_apvfx[VFX_KINECT1_PCL] = &g_tVFXKinect1PCLOps;
    
    return 0;
}

int vfx_kinect1_pcl_init()
{
    printf("vfx_kinect1_pcl_init()\n");
    return 0;
}

void vfx_kinect1_pcl_free()
{
    printf("vfx_kinect1_pcl_free()\n");
}

void vfx_kinect1_pcl_draw()
{
    vfx_kinect1_pcl_DrawGLScene();
}
...
// int vfx_kinect1_pcl_main(int argc, char **argv)
// {
//     glutInit(&argc, argv);
// 
