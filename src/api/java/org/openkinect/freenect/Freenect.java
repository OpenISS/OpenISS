...
public class Freenect implements Library {
	...
	static int FREENECT_DEVICE_MOTOR  = 0x01;
...
//			Native.register(instance);
			...
			try {
			    ...
			    String path = PROJECT_HOME + "/lib/v1/mac/";
...
//				LibraryPath libPath = new LibraryPath();
	...
	public static Context createContext () {
		...
		if (rval == 0) {
			...
			// Had to add this or else some weird audio thing would break!
			freenect_select_subdevices(ctx, FREENECT_DEVICE_CAMERA | FREENECT_DEVICE_MOTOR);
